...
Multi-Agent Architecture: This role manages a sophisticated containerized system where Yanay.ai orchestration routes family messages to specialized Nina (scheduler), Huata (calendar), and Lyco (project manager) agents via docker-compose managed containers at /root/demestihas-ai/.