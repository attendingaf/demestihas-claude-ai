...
# EA-AI Bootstrap Integration Setup Script
# This script integrates EA-AI with Claude Desktop

set -e

echo "🚀 EA-AI Claude Desktop Integration Setup"
echo "=========================================="
...
echo -e "${YELLOW}Step 3: Installing EA-AI dependencies...${NC}"
cd "$EA_AI_DIR"
...
if [ $? -eq 0 ]; then
    ...
    echo -e "${YELLOW}⚠ Warning: MCP SDK may not be available, continuing with basic setup${NC}"
fi
